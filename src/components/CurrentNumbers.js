    ...
    return (
        <div className='currentNumbersContainer'>
            <div className='currentNumber'>
                ...
                <CountUp delay={1} end={624} duration={3} className='countingNumber' />
            </div>
            <div className='currentNumber'>
                ...
                <CountUp delay={1} end={377} duration={3} className='countingNumber' />
            </div>
            <div className='currentNumber'>
                ...
                <CountUp delay={1} end={9} duration={3} className='countingNumber' />
            </div>
            <div className='currentNumber'>
                ...
                <CountUp delay={1} end={2574} duration={3} className='countingNumber' />
            </div>
        </div>
    )
}

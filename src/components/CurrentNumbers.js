    ...
    return (
        <div className='currentNumbersContainer'>
            <div className='currentNumber'>
                ...
                <CountUp delay={2} end={718} duration={4} className='countingNumber' />
            </div>
            <div className='currentNumber'>
                ...
                <CountUp delay={2} end={378} duration={4} className='countingNumber' />
            </div>
            <div className='currentNumber'>
                ...
                <CountUp delay={2} end={10} duration={4} className='countingNumber' />
            </div>
            <div className='currentNumber'>
